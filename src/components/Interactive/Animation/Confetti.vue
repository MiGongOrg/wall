<template>
  <div class="confetti" v-show="isShow">
    ...
    <div class="countdown-box">
      <div class="countdown-colored-blocks">
        ...
        <div class="countdown-text" @click="resetGame">Reset</div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    resetGame () {
      this.isShow = false
      clearInterval(this.timer)
      this.$store.dispatch('ResetShakesCount')
    ...
    confetti () {
      ...
      this.timer = setInterval(this.draw, 23);
    },
    draw () {
